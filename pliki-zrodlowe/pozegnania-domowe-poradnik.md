...
- [poradnik dla odbiorców indywidualnych](/pobierz/pozegnanie-domowe-blisko-na-ostatniej-drodze.pdf), czyli dla każdej i każdego z nas;
- a także [przewodnik wdrożeniowy, który kieruję przede wszystkim do instytucji](/pobierz/blisko-na-ostatniej-drodze-poradnik-wdrozeniowy-dla-instytucji-uslug-spolecznych.pdf) związanych z opieką na ostatnim etapie życia: hospicjów, domów pomocy społecznej, zakładów opiekuńczo-leczniczych, szpitali. Wierzę, że nawet, gdy śmierć następuje w jednym z tych miejsc, można przy odrobinie zaangażowania stwarzać warunki do pożegnania „jak w domu”.
...
<div class="flex flex-col sm:flex-row gap-6 justify-between">
  ...
  <a href="/pobierz/blisko-na-ostatniej-drodze-poradnik-wdrozeniowy-dla-instytucji-uslug-spolecznych.pdf"><img src="/obrazki/blisko-na-ostatniej-drodze-poradnik-wdrozeniowy-dla-instytucji-uslug-spolecznych-okladka.webp" alt="Pobierz PDF „Blisko na ostatniej drodze. Przewodnik wdrożeniowy dla instytucji usług społecznych”" width="330" height="470" /></a>
</div>
